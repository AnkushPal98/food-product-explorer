...
const ProductCard = ({ product }) => {
    return (
      <div className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow hover:cursor-pointer hover:border-3 hover:border-sky-500 bg-white shadow-sm h-full flex flex-col">
